...
from mlops_grp5.onnx_api import app
...
def test_read_root():
    with TestClient(app) as client:
        ...
        assert response.json() == {"message": "FastAPI ONNX Inference Application is running!"}

def test_valid_predict():
    with TestClient(app) as client:
        test_image_path = "tests/data/fresh_sample.jpg"  # Replace with your valid test image path
